...
Один студент состоит максимум в одной группе. В группе может быть сколько угодно студентов, лимита нет. Уроки принадлежат конкретной группе, а не глобальному каталогу.
